    ...
    const testimonials = [
        {
            ...
            text: "    Обслуживание в отеле Monteleone было исключительным. Не было абсолютно ни одной проблемы, которая не была бы решена своевременно и с удовлетворительными результатами. Мы были особенно впечатлены тем, как персонал отеля предвосхитил наши потребности (периодически заходя в зал заседаний, чтобы проверить с нами). Многочисленные участники конференции прокомментировали качество еды, качество обслуживания и общее позитивное отношение к месту проведения конференции. Особого внимания заслуживает долговечность персонала и чувство вложенности в успех каждого мероприятия. Обычно я предлагаю предложения по улучшению (часть моей работы профессором маркетинга), но нет абсолютно ничего, что можно было бы улучшить — вы установили очень высокую планку.",
            rating: 5,
        },
        {
            date: "25 Mar, 2023",
